// ===================================================================
// File: src/components/dashboard/DashboardOverview.jsx - FIXED
'use client';
...
const DashboardOverview = () => {
  ...
  const stats = [
    ...
    {
      title: 'Độ chính xác',
      value: `${((overviewData.accuracy || overviewData.Accuracy || 0) * 100).toFixed(1)}%`,
      icon: '⚡',
      color: 'bg-yellow-50 text-yellow-800'
    },
    {
      title: 'Đánh giá TB',
      value: (overviewData.averageRating || overviewData.AverageRating || 0).toFixed(1),
      icon: '⭐',
